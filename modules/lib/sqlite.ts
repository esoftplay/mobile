...
export default class esqlite {
  ...
  init(dbname?: string, createStatement?: string, version: string = '1', description?: string, size: any = null) {
    if (dbname) {
  ...
  create(createStatement: string, debug: number = 0): Promise<any> {
  ...
  drop(dbname: string, debug: number = 0): Promise<any> {
    return new Promise((resolve, reject) => {
      this.db.transaction((tx: any) => {
  ...
  execute(sqlStatement: string, callback?: (e: any) => void, debug: number = 0): Promise<any> {
  ...
  verify(values: any, debug: number = 0): any {
  ...
  Insert(values: any, callback?: (insertId: number) => void, debug: number = 0): Promise<any> {
  ...
  Update(id: string | number, values: any, callback?: (rowsAffected: number) => void, debug: number = 0): Promise<any> {
    return new Promise((r, j) => {
      values = this.verify(values);
      var arValues: any = []
  ...
  Delete(id?: string | number, fields?: string[], params?: any[], callback?: (rowsAffected: number) => void, debug: number = 0): Promise<any> {
    return new Promise((r, j) => {
      var query: string = '';
      if (id) {
  ...
  getRow(id?: string | number, fields?: string[], params?: any[], callback?: (row: any) => void, debug: number = 0): Promise<any> {
    return new Promise((r, j) => {
      var query: string = ''
      if (id) {
  ...
  getAll(fields?: string[], params?: any[], orderBy?: string, limit?: number, offset?: number, groupBy?: string, callback?: (data: any) => void, debug: number = 0): Promise<any> {
    return new Promise((r, j) => {
  ...
  configConsole(message?: any, ...optionalParams: any[]) {
    if (this.isDebug === 1) {
